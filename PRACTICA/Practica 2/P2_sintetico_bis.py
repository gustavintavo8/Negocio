...
from sklearn.feature_selection import VarianceThreshold, SelectKBest, SelectPercentile, f_classif, RFECV
from sklearn.svm import SVC
from sklearn.ensemble import ExtraTreesClassifier
from sklearn import preprocessing

# Parte 1 -> Generación del dataset sintético con más características
print("# Generación del dataset sintético")
X, y = make_classification(n_samples=1000,
                           n_features=20,  # Aumentamos el número de características
                           n_informative=5,  # Más características informativas
                           n_redundant=2,
                           n_repeated=0,
                           n_classes=2,
                           random_state=0,
...
selector_f_classif_kbest = SelectKBest(score_func=f_classif, k=5)  # Aumentamos k para capturar más características
